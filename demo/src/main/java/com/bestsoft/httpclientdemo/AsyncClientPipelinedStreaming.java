...
/**
 * This example demonstrates a pipelinfed execution of multiple HTTP request /
 * response exchanges with a full content streaming.
 */
public class AsyncClientPipelinedStreaming {
	...
	public static void main(final String[] args) throws Exception {
		...
		try {
			...
			HttpHost targetHost = new HttpHost("www.iteye.com");
			HttpGet[] resquests = { new HttpGet("/news/31161"), new HttpGet("/news/31159"),
					new HttpGet("/news/31160"), new HttpGet("/news/31161") };
	...
	static class MyResponseConsumer extends AsyncCharConsumer<Boolean> {
		...
		protected void onResponseReceived(final HttpResponse response) {
			file = String.valueOf(response.getHeaders("ETag").hashCode());
...
//				System.out.print(buf.get());
		...
		protected Boolean buildResult(final HttpContext context) {
			FileUtil.saveFile("F:/da"+file+".html", sb.toString());
			System.out.println("=================================================");
			System.out.println();
			return Boolean.TRUE;
		}
