...
public class PKCS7Tool {
	...
	public String sign(byte[] data) throws Exception {
		...
		// SignerInfo
		Constructor signerInfoConstructor = SignerInfo.class.getConstructor(new Class[] { x500Name, BigInteger.class, algorithmId, PKCS9Attributes.class,
				algorithmId, byte[].class, PKCS9Attributes.class });
		// 签名信息
		...
		// PKCS7
		Constructor pkcs7Constructor = PKCS7.class.getConstructor(new Class[] { digestAlgorithmIds.getClass(), ContentInfo.class, X509Certificate[].class,
	 ...
	 */
	public void verify(String signature, byte[] data, String dn) throws IOException, NoSuchAlgorithmException, SignatureException, InvalidKeyException,
