...
public class MMSegAnalyzerTest {
	...
	public void testComplex() throws IOException {
		...
		/*
		 * txt = "第一卷 云天落日圆 第一节 偷欢不成倒大霉"; txt = "中国人民银行"; txt = "我们"; txt =
	...
	/*
	 * @Test public void testCutLeeterDigitFilter() { String myTxt =
	 * "mb991ch cq40-519tx mmseg4j "; List<String> words = toWords(myTxt, new
	 * MMSegAnalyzer("") {
	 * 
	 * @Override protected TokenStreamComponents createComponents(String text) {
	 * Reader reader = new BufferedReader(new StringReader(text)); Tokenizer t =
	 * new MMSegTokenizer(newSeg(), reader); return new TokenStreamComponents(t,
	 * new CutLetterDigitFilter(t)); }
	 * 
	 * 
	 * });
	 * 
	 * //Assert.assertArrayEquals("CutLeeterDigitFilter fail", words.toArray(new
	 * String[words.size()]), "mb 991 ch cq 40 519 tx mmseg 4 j".split(" "));
